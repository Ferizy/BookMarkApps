...
public class ReadingFragment extends Fragment {
    ...
    TextView readingTV;
    RecyclerView readingRV;
    BookmarksRecyclerviewAdapter bookmarksAdapter;
    ArrayList<BookVolume> readingList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_reading, container, false);


        readingRV = root.findViewById(R.id.readingRV);
        readingTV = root.findViewById(R.id.readingTV);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if(readStatus.equals("READING")){
                        readingList.add(new BookVolume(volumeID,readStatus));
                    }
                }

                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
                readingRV.setLayoutManager(layoutManager);
                bookmarksAdapter = new BookmarksRecyclerviewAdapter(getContext(), readingList);
                readingRV.setAdapter(bookmarksAdapter);
